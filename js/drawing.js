...
game.redraw = function () {
  ...
  (game.counter.innerHTML =
    "A game by Karol Swierczek and edited by Hoang Linh | Controls: A, D / arrows and SPACE | Points: " +
    Math.round(-game.player.highestY / (3 * game.options.tileHeight))),
    (game.mobielCounter.innerHTML =
      "A game by Karol Swierczek and edited by Hoang Linh | Controls: A, D / arrows and SPACE | Points: " +
      Math.round(-game.player.highestY / (3 * game.options.tileHeight))),
...
game.requestRedraw = function () {
  ...
  if (game.isOver) {
    ...
    game.context.font = "9px Georgia";
    game.context.fillText(
      "(Refresh the page to restart)",
      game.canvas.width / 2,
      game.canvas.height / 3 + 50
    );
  }
};
